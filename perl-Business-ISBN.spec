...
%prep
%setup -q -n Business-ISBN-3.006
cd %{_builddir}/Business-ISBN-3.006
...
cp %{_builddir}/Business-ISBN-3.006/LICENSE %{buildroot}/usr/share/package-licenses/perl-Business-ISBN/82ce67a707da5f494c881d7476b134fb8d731c5d
if test -f Makefile.PL; then
