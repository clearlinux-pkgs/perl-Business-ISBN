...
Source0  : https://cpan.metacpan.org/authors/id/B/BR/BRIANDFOY/Business-ISBN-3.009.tar.gz
...
%prep
%setup -q -n Business-ISBN-3.009
cd %{_builddir}/Business-ISBN-3.009
pushd ..
cp -a Business-ISBN-3.009 buildavx2
popd
