...
%prep
%setup -q -n Business-ISBN-3.005
cd %{_builddir}/Business-ISBN-3.005
...
cp %{_builddir}/Business-ISBN-3.005/LICENSE %{buildroot}/usr/share/package-licenses/perl-Business-ISBN/82ce67a707da5f494c881d7476b134fb8d731c5d
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.2/Business/ISBN.pm
/usr/lib/perl5/vendor_perl/5.30.2/Business/ISBN10.pm
/usr/lib/perl5/vendor_perl/5.30.2/Business/ISBN13.pm
