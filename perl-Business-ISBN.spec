...
Source0  : https://cpan.metacpan.org/authors/id/B/BD/BDFOY/Business-ISBN-3.007.tar.gz
...
%prep
%setup -q -n Business-ISBN-3.007
cd %{_builddir}/Business-ISBN-3.007
...
cp %{_builddir}/Business-ISBN-3.007/LICENSE %{buildroot}/usr/share/package-licenses/perl-Business-ISBN/82ce67a707da5f494c881d7476b134fb8d731c5d
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Business-ISBN/82ce67a707da5f494c881d7476b134fb8d731c5d

%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/Business/ISBN.pm
/usr/lib/perl5/vendor_perl/5.34.0/Business/ISBN10.pm
/usr/lib/perl5/vendor_perl/5.34.0/Business/ISBN13.pm
